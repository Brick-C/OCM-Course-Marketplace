...
/**
 * @typedef {import("@/sanity.types").GetCoursesQueryResult[number]} Course
 */

/**
 * @param {{ course: Course, progress: number, href: string }} props
 */
const CourseCard = ({ course, progress, href }) => {
  return (
    <Link
      href={href}
      prefetch={false}
        ...
        <div className="relative h-52 w-full overflow-hidden">
          {course.image ? (
            <Image
              ...
              fill
              className="object-cover object-center transition-transform duration-300  group-hover:scale-115"
            />
          ) : (
